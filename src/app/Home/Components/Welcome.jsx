...
function Welcome() {
    ...
    return (
        <div className="bg-black min-h-[70vh] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-16">
            {/* Contenedor principal con efecto de degradado de fondo sutil */}
            <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
                {/* Título principal con la frase "Bienvenido sea" */}
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight">
                    Bienvenido sea{' '}
                    {/* Span con efecto de degradado animado para "el futuro" */}
                ...
                {/* Subtítulo con mensaje cautivador */}
            ...
            {/* Efecto decorativo de fondo - círculo con gradiente */}
